...
namespace KourseLibraryRV
{
    public partial class Readers : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                dataAdapter = new SqlDataAdapter("SELECT * , 'Delete' AS [Command] FROM Readers ", sqlConnection);
                ...
                dataAdapter.Fill(dataSet, ("Readers"));
                dataGridView1.DataSource = dataSet.Tables["Readers"];
